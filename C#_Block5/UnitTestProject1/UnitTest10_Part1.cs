...
namespace UnitTestProject1
{
    ...
    public class UnitTest10_Part1
    {
        ...
        public void TestBackYard()
        {
            ...
            Assert.AreEqual("You're standing in the Back Yard. You see exits to the following places:  Front Yard, Garden. It's very hot. You see a screen door.",
                currentLocation.Description);
        }
        [TestMethod]
        ...
        public void TestMoveThroughExteriorDoorException()
        {
            Location currentLocation = diningRoom;
            HouseMove houseMove = new HouseMove(currentLocation);
            houseMove.GoThroughExteriorDoor();
